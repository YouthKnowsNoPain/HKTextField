...
class HKTextField: UITextField,UITextFieldDelegate {
    ...
    @objc fileprivate func textFieldMaxLenthDidChange(textField:UITextField) {
        ...
        if lang == "zh-Hans" { // 中文
            ...
            if let selectedRange = textField.markedTextRange {
                ...
                if (position == nil) && toBeString.characters.count > textMaxLength {
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        case .count:
            ...
            var buffer:NSString?
            if !scanner.scanCharacters(from: numbers, into: &buffer) && string.characters.count != 0 {
                return false
            }
            return true
        case .countNonZeroFront:
            ...
            if zeroRange.length == 1 && zeroRange.location == 0 {
                if string != "0" && string != "." && text.characters.count == 1 {
        ...
        case .money:
            ...
            let strlen = tempStr.characters.count
